...
<body class="min-h-screen bg-[#020b1a] text-white antialiased">
  ...
  <main class="mx-auto max-w-4xl px-4 py-8 sm:px-6 sm:py-10">
    ...
    <article class="mt-5 rounded-3xl border border-white/15 bg-white/5 p-5 sm:p-8">
      ...
      <img src="../../../../imagens/posts/coderush-tecnologia-2026-04-26.jpg" alt="CodeRush: como usar TECNOLOGIA de forma pratica" class="mt-6 w-full rounded-2xl border border-white/15" width="1200" height="630" loading="lazy" />
