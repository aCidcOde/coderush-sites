...
<body class="bg-brand text-white antialiased font-[var(--font-body)] site-optimized">
  ...
  <header id="site-header" class="sticky top-0 z-40 border-b border-white/10 bg-brand/95 backdrop-blur">
    <div class="mx-auto max-w-[1140px] px-4 sm:px-6">
      ...
      <div class="pb-3 lg:hidden">
        <details class="group rounded-2xl border border-white/20 bg-white/5 p-2">
          <summary class="flex cursor-pointer list-none items-center justify-between rounded-xl px-3 py-2 text-sm font-semibold">
            Navegação
          ...
          <div class="mt-2 grid gap-2 px-1 pb-1 text-sm font-medium">
            <a href="#funcionalidades" class="rounded-lg border border-white/20 bg-white/5 px-3 py-2">Funcionalidades</a>
  ...
  <main id="conteudo" class="mx-auto max-w-[1140px] px-4 sm:px-6">
    <section id="secao1" class="grid items-center gap-6 py-8 md:py-10 lg:grid-cols-2 lg:gap-10">
      <div class="space-y-5">
        ...
        <p class="max-w-[620px] text-base leading-relaxed text-white/90 sm:text-lg">
          ...
          MULTI-Idioma ( PT-BR, ES e EN ), Dólar, Real, Euro e Matrizes de todos os tipos.
        </p>
        <a href="#contato" class="inline-flex items-center gap-2 rounded-full border border-white/70 px-5 py-2.5 text-sm font-semibold uppercase tracking-wide hover:bg-white/10">
          Quero testar uma demonstração
        </a>
      </div>
      <div class="mx-auto w-full max-w-[520px] rounded-2xl bg-brand-soft/25 p-2 ring-1 ring-white/15">
        <div class="lottie-box h-[220px] w-full sm:h-[300px]" data-lottie-src="imagens/lottie-hero.json" aria-label="Animação demonstrativa do sistema"></div>
      </div>
    </section>
    ...
    <section id="funcionalidades" class="scroll-mt-28 py-10">
      ...
      <div class="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        <article class="rounded-[30px] border border-white/55 bg-brand p-5 text-center">
          <img decoding="async" src="imagens/pagamento-online.webp" alt="Integração com Meios de Pagamento" class="mx-auto h-14 w-14" width="512" height="512" loading="lazy" />
        ...
        <article class="rounded-[30px] border border-white/55 bg-brand p-5 text-center">
          <img decoding="async" src="imagens/erp.webp" alt="Integração com ERP" class="mx-auto h-14 w-14" width="128" height="128" loading="lazy" />
        ...
        <article class="rounded-[30px] border border-white/55 bg-brand p-5 text-center">
          <img decoding="async" src="imagens/no-mundo-todo.webp" alt="Módulo Logistica 1" class="mx-auto h-14 w-14" width="512" height="512" loading="lazy" />
        ...
        <article class="rounded-[30px] border border-white/55 bg-brand p-5 text-center">
          <img decoding="async" src="imagens/grafico-de-barras.webp" alt="Relatórios Completos" class="mx-auto h-14 w-14" width="512" height="512" loading="lazy" />
        ...
        <article class="rounded-[30px] border border-white/55 bg-brand p-5 text-center">
          <img decoding="async" src="imagens/mapa-do-site.webp" alt="Qualquer Plano de Compensação" class="mx-auto h-14 w-14" width="512" height="512" loading="lazy" />
        ...
        <article class="rounded-[30px] border border-white/55 bg-brand p-5 text-center">
          <img decoding="async" src="imagens/trabalho-em-equipe.webp" alt="Responsivo no Mobile" class="mx-auto h-14 w-14" width="512" height="512" loading="lazy" />
    ...
    <section class="py-8">
      <h3 class="font-[var(--font-heading)] text-xl font-semibold">Veja abaixo um video explicando o funcionamento básico do sistema</h3>
      <div class="mt-4 overflow-hidden rounded-2xl border border-white/20 bg-brand-dark/30">
        <div class="aspect-video">
          <iframe
            class="h-full w-full"
            title="YouTube video player"
            src="https://www.youtube.com/embed/b1-JqxgRhas"
            loading="lazy"
    ...
    <section id="porque" class="scroll-mt-28 py-10">
      <div class="grid items-center gap-6 lg:grid-cols-2">
        <div class="mx-auto w-full max-w-[420px] rounded-2xl bg-brand-soft/25 p-2 ring-1 ring-white/15">
          <div class="lottie-box h-[240px] w-full sm:h-[320px]" data-lottie-src="imagens/lottie-porque.json" data-lottie-mobile="false" aria-label="Animação de gestão"></div>
        </div>

        <div>
          <h4 class="font-[var(--font-heading)] text-[30px] font-semibold leading-tight">Por que escolher a Sistema Venda Direta?</h4>
          <div class="mt-2 h-1 w-[72px] rounded-full bg-white"></div>
    ...
    <section id="secao4" class="py-10">
      <div class="grid items-center gap-6 lg:grid-cols-2">
        <div>
          <h3 class="font-[var(--font-heading)] text-2xl font-semibold">Características do Sistema</h3>
          <h4 class="mt-2 font-[var(--font-heading)] text-xl font-semibold">Sistema de Gestão de Marketing Multinível</h4>
          <div class="mt-2 h-1 w-[72px] rounded-full bg-white"></div>
          <p class="mt-4 text-base leading-relaxed text-white/90">
            O sistema venda direta foi primariamente desenhado para empresas de marketing multinível, vendas direta ou marketing de rede,
            como queira chamar, hoje funciona com quatro módulos: Administração, Centro de Distribuição, Escritório Virtual e Loja Virtual.
          </p>
        </div>
        <div class="mx-auto w-full max-w-[420px] rounded-2xl bg-brand-soft/25 p-2 ring-1 ring-white/15">
          <div class="lottie-box h-[240px] w-full sm:h-[320px]" data-lottie-src="imagens/lottie-caracteristicas.json" aria-label="Animação de características"></div>
        </div>
      </div>
    </section>

    <section id="vantagens" class="scroll-mt-28 py-10">
      ...
      <div class="mt-6 grid gap-4 md:grid-cols-3">
        <article class="rounded-2xl border border-white/25 bg-white/5 p-5 text-center">
          <div class="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-white/15 text-xl">💰</div>
          <h5 class="mt-3 font-[var(--font-heading)] text-lg font-semibold">Economia</h5>
          <p class="mt-2 text-sm text-white/85">Um sistema online integrado com diversas ferramentas para te auxiliar na administração e controle.</p>
        </article>

        <article class="rounded-2xl border border-white/25 bg-white/5 p-5 text-center">
          <div class="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-white/15 text-xl">🧩</div>
          <h5 class="mt-3 font-[var(--font-heading)] text-lg font-semibold">Sob Medida</h5>
          <p class="mt-2 text-sm text-white/85">Se você tem alguma idéia ou uma visão diferente, criamos um sistema sob medida para você.</p>
        </article>

        <article class="rounded-2xl border border-white/25 bg-white/5 p-5 text-center">
          <div class="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-white/15 text-xl">😊</div>
          <h5 class="mt-3 font-[var(--font-heading)] text-lg font-semibold">Facilidade</h5>
          <p class="mt-2 text-sm text-white/85">Sistema simples e descomplicado, tanto para o consultor como para o administrador.</p>
        </article>
      </div>
    </section>
    ...
    <section id="desenvolvimento-ia" class="scroll-mt-28 py-10">
      <div class="rounded-[30px] border border-white/30 bg-white/[0.06] p-6 sm:p-8">
        <div class="grid items-center gap-6 lg:grid-cols-[1fr_auto]">
          <div>
            <h4 class="font-[var(--font-heading)] text-[30px] font-semibold leading-tight">Desenvolvimento com IA para acelerar sua operação</h4>
            <div class="mt-2 h-1 w-[72px] rounded-full bg-white"></div>
    ...
    <section id="clientes" class="scroll-mt-28 py-10">
      ...
      <div class="mt-2 h-1 w-[72px] rounded-full bg-white"></div>
      <h2 class="mt-4 font-[var(--font-heading)] text-xl font-semibold sm:text-2xl">Confira o que alguns clientes têm a dizer sobre o Sistema Venda Direta.</h2>
      ...
      <div class="mt-6 grid gap-4 md:grid-cols-2">
        ...
        <article class="rounded-2xl border border-white/20 bg-white/5 p-5">
          ...
          <div class="mt-4 flex items-center gap-3">
            <img decoding="async" src="imagens/logo_sistema-q5j2yjxlnn52kfujrc1mx3thco5hr6uayh8v191vgg.webp" alt="Emergency Doc Imob" class="h-10 w-10 rounded-full bg-white/15 p-1" loading="lazy" />
            <div>
        ...
        <article class="rounded-2xl border border-white/20 bg-white/5 p-5">
          ...
          <div class="mt-4 flex items-center gap-3">
            <img decoding="async" src="imagens/logo-1-q5j39t21h8jnkdi31p5u9rl5dqoowqim66f4vid6yo.webp" alt="Science Life" class="h-10 w-10 rounded-full bg-white/15 p-1" loading="lazy" />
            <div>
        ...
        <article class="rounded-2xl border border-white/20 bg-white/5 p-5">
          ...
          <div class="mt-4 flex items-center gap-3">
            <img decoding="async" src="imagens/341249332_244034884767561_2785740054709534699_n-150x150.webp" alt="SP Diversoões" class="h-10 w-10 rounded-full" loading="lazy" />
            <div>
    ...
    <section id="form" class="scroll-mt-28 py-10">
      ...
      <div class="mt-6 grid gap-6 lg:grid-cols-[1.05fr_0.95fr]">
        ...
        <div class="rounded-[28px] border border-white/20 bg-white/5 p-5 sm:p-6">
          ...
          <p class="mt-2 text-sm text-white/85">Enviamos seu lead para a equipe e, na sequencia, uma pessoa real via entrar em contato..</p>
          ...
          >
            ...
            <button type="submit" class="inline-flex w-full items-center justify-center rounded-full bg-white px-5 py-3 text-sm font-semibold uppercase tracking-wide text-brand transition hover:-translate-y-0.5 hover:bg-white/90">
          ...
          <?php if ($mailStatus === 'ok'): ?>
            <div class="mt-4 rounded-2xl border border-emerald-300/30 bg-emerald-500/10 p-4">
              ...
              <a id="contact-success-whatsapp-link" href="https://wa.me/5511994566726" target="_blank" rel="noopener noreferrer" class="mt-3 inline-flex w-full items-center justify-center rounded-full border border-emerald-200/45 px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-white/10">
    ...
    <section class="py-10">
      ...
      <div class="mt-6 space-y-2">
        <details class="rounded-lg border border-white/20 bg-white/5 p-4">
          <summary class="cursor-pointer font-semibold">JÁ POSSUO UM SISTEMA, POSSO MIGRAR OS DADOS?</summary>
          <p class="mt-2 text-sm text-white/90">Sim, podemos fazer a migração dos dados do seu antigo sistema, desde que tenhamos acesso a eles de forma organizada.</p>
        </details>
        ...
        <details class="rounded-lg border border-white/20 bg-white/5 p-4">
          <summary class="cursor-pointer font-semibold">JÁ TENHO UM PLANO DE NEGÓCIOS, É POSSÍVEL USÁ-LO?</summary>
          <p class="mt-2 text-sm text-white/90">Sim, a instalação contempla a parametrização do seu plano de negócios.</p>
        </details>
        ...
        <details class="rounded-lg border border-white/20 bg-white/5 p-4">
          <summary class="cursor-pointer font-semibold">ALÉM DA MENSALIDADE, EXISTE OUTROS CUSTOS?</summary>
          <p class="mt-2 text-sm text-white/90">Não temos taxas extras, poderá existir cobranças novas na medida em que o cliente peça novas funcionalidades, para isso existirá um acordo prévio.</p>
        </details>
      ...
      <div class="flex items-end justify-between gap-4">
        <div>
          <h2 class="font-[var(--font-heading)] text-[30px] font-semibold">Blog SVD</h2>
          <div class="mt-2 h-1 w-[72px] rounded-full bg-white"></div>
        </div>
  ...
  <footer class="mt-10 border-t border-white/15 bg-brand-dark/40">
    <div class="mx-auto max-w-[1140px] px-4 py-10 sm:px-6">
      ...
      <div class="mt-8 border-t border-white/15 pt-4 text-xs text-white/70">
        <div class="mb-4 border-b border-white/15 pb-4">
