  ...
  <main class="mx-auto max-w-[900px] px-4 py-8 sm:px-6 sm:py-10">
    ...
    <article class="mt-5 overflow-hidden rounded-3xl border border-white/15 bg-white/5">
      <figure class="relative">
        <img src="../../../../imagens/posts/seguranca-agentica-em-2026-checklist-com-nist-cyber-ai-profile-e-owasp.jpg" alt="Como se proteger de golpes de pirâmide e evitar cair em armadilhas financeiras" class="block w-full object-cover" style="aspect-ratio:1200/630" width="1200" height="630" loading="eager" decoding="async" />
        ...
        <figcaption class="absolute inset-x-0 bottom-0 p-5 sm:p-8 lg:p-10">
          ...
          <p class="mt-3 text-[11px] font-semibold uppercase tracking-[0.22em] text-white/85 sm:text-xs">Blog SVD • 07/06/2023</p>
          <h1 class="mt-2 text-2xl font-semibold leading-tight text-white sm:text-3xl lg:text-4xl">Como se proteger de golpes de pirâmide e evitar cair em armadilhas financeiras</h1>
