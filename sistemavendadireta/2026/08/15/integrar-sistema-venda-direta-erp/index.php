...
<!-- PROMO-STRIP END -->
    ...
    <article class="mt-5 overflow-hidden rounded-3xl border border-white/15 bg-white/5">
      ...
      <aside class="my-8 rounded-2xl border-l-4 border-white bg-white/10 p-5 sm:p-6">
        <p class="text-sm leading-7 text-white/90 sm:text-base">Já estruturamos integrações com sucesso em vários clientes. Vale a pena discutir como isso pode se aplicar ao seu cenário específico. <a href="../../../../sistema-mmn/?utm_source=blog&amp;utm_medium=post&amp;utm_campaign=cta-artigo" class="font-semibold text-white underline decoration-white/40 underline-offset-4 hover:text-white">Solicite um orcamento →</a></p>
      </aside>
      <section class="mt-8">
      ...
      <p class="my-6 text-sm leading-7 text-white/85 sm:text-base">
        Explore como um software para empresa de venda direta pode facilitar essa integração. <a href="../../../../sistema-mmn/?utm_source=blog&amp;utm_medium=post&amp;utm_campaign=cta-artigo" class="font-semibold text-white underline decoration-white/40 underline-offset-4 hover:text-white">Solicite um orcamento →</a>
      </p>
      <section class="mt-8">
