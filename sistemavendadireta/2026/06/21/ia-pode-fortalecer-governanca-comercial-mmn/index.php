...
<head>
  ...
  <title>Como a IA pode fortalecer | Sistema Venda Direta</title>
  ...
  <meta property="og:title" content="Como a IA pode fortalecer | Sistema Venda Direta" />
  ...
  <meta name="twitter:title" content="Como a IA pode fortalecer | Sistema Venda Direta" />
  ...
  <main class="mx-auto max-w-4xl px-4 py-8 sm:px-6 sm:py-10">
    ...
    <article class="mt-5 overflow-hidden rounded-3xl border border-white/15 bg-white/5">
      ...
      <aside class="my-8 rounded-2xl border-l-4 border-white bg-white/10 p-5 sm:p-6">
        <p class="text-sm leading-7 text-white/90 sm:text-base">Já estruturamos isso em diversos clientes. Vale a pena avaliar como a IA pode trazer previsibilidade. Se faz sentido para o seu cenário, vamos conversar. <a href="../../../../#contato" class="font-semibold text-white underline decoration-white/40 underline-offset-4 hover:text-white">Solicite um orcamento →</a></p>
      </aside>
      <section class="mt-8">
      ...
      <p class="my-6 text-sm leading-7 text-white/85 sm:text-base">
        Explore como um software para vendas diretas pode ser um diferencial na sua operação. <a href="../../../../#contato" class="font-semibold text-white underline decoration-white/40 underline-offset-4 hover:text-white">Solicite um orcamento →</a>
      </p>
      <section class="mt-8">
