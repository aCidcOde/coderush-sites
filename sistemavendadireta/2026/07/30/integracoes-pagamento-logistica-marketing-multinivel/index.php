  ...
  <main class="mx-auto max-w-4xl px-4 py-8 sm:px-6 sm:py-10">
    ...
    <article class="mt-5 overflow-hidden rounded-3xl border border-white/15 bg-white/5">
      ...
      <aside class="my-8 rounded-2xl border-l-4 border-white bg-white/10 p-5 sm:p-6">
        <p class="text-sm leading-7 text-white/90 sm:text-base">Já estruturamos isso em diversos clientes e os resultados falam por si. Vale a pena avaliar se a integração se faz sentido para o seu cenário. <a href="../../../../#contato" class="font-semibold text-white underline decoration-white/40 underline-offset-4 hover:text-white">Solicite um orcamento →</a></p>
      </aside>
      <section class="mt-8">
      ...
      <p class="my-6 text-sm leading-7 text-white/85 sm:text-base">
        Vamos explorar como podemos ajudar você a otimizar seus processos. <a href="../../../../#contato" class="font-semibold text-white underline decoration-white/40 underline-offset-4 hover:text-white">Solicite um orcamento →</a>
      </p>
      <section class="mt-8">
