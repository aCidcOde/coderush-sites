...
<head>
  ...
  <title>Sistema Venda Direta: como usar IA de forma prática | Sistema Venda Direta</title>
  ...
  <meta property="og:title" content="Sistema Venda Direta: como usar IA de forma prática | Sistema Venda Direta" />
  ...
  <meta name="twitter:title" content="Sistema Venda Direta: como usar IA de forma prática | Sistema Venda Direta" />
...
<body class="min-h-screen bg-brand text-white antialiased">
  ...
  <main class="mx-auto max-w-4xl px-4 py-8 sm:px-6 sm:py-10">
    ...
    <article class="mt-5 rounded-3xl border border-white/15 bg-white/5 p-5 sm:p-8">
      ...
      <h1 class="mt-3 text-3xl font-semibold leading-tight text-white sm:text-4xl">Sistema Venda Direta: como usar IA de forma prática</h1>
