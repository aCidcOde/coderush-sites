...
$whatsappMessage = 'Ola! Tenho uma marca de cosmeticos e vim pela campanha de 50% na instalacao. Quero ver o sistema.';
...
$seoTitle = 'Sistema para revenda de cosméticos com consultoras | Sistema Venda Direta';
$seoDescription = 'Sistema para marca de cosméticos que vende por consultoras: escritório virtual, catálogo por linhas, comissões e loja. Instalação com 50% de desconto.';
?>
<!doctype html>
<html lang="pt-BR">
<head>
  ...
  <meta property="og:title" content="Sistema para revenda de cosméticos — 50% off na instalação" />
        ...
        <div class="grid gap-8 lg:grid-cols-[1fr_1fr]">
          ...
          <div class="rounded-[24px] border border-white/20 bg-brand-dark/40 p-5 sm:p-6">
            ...
            >
              ...
              <input type="hidden" name="servico" value="Sistema Venda Direta — 50% instalacao (lp-oferta-cosmeticos)" />
