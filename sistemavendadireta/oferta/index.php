...
$whatsappMessage = 'Ola! Vim pela campanha de instalacao com desconto do Sistema Venda Direta. Quero garantir minha vaga.';
...
$seoTitle = 'Sistema de venda direta com instalação em oferta | Sistema Venda Direta';
$seoDescription = 'Plataforma completa de MMN e venda direta: escritório virtual, loja, rede e financeiro. '
    . 'Instalação promocional (R$ 3.500 em 2x ou R$ 3.000 à vista) e implantação assistida por IA.';
?>
<!doctype html>
<html lang="pt-BR">
<head>
  ...
  <meta property="og:title" content="Instalação em oferta — Sistema Venda Direta" />
