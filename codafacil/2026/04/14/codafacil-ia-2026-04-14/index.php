...
<body class="min-h-screen bg-[#04110d] text-white antialiased">
  ...
  <main class="mx-auto max-w-4xl px-4 py-8 sm:px-6 sm:py-10">
    ...
    <article class="mt-5 rounded-3xl border border-white/15 bg-white/5 p-5 sm:p-8">
      ...
      <h1 class="mt-3 text-3xl font-semibold leading-tight text-white sm:text-4xl">Codafacil.dev: como usar IA de forma pratica</h1>
      ...
      <img src="../../../../imagens/posts/codafacil-ia-2026-04-14.jpg" alt="Codafacil.dev: como usar IA de forma pratica" class="mt-6 w-full rounded-2xl border border-white/15" width="1200" height="630" loading="lazy" />
