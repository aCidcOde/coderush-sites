...
<head>
  ...
  <title>Codafacil.dev: como usar IA de forma prática | Codafacil.dev</title>
  ...
  <meta property="og:title" content="Codafacil.dev: como usar IA de forma prática | Codafacil.dev" />
  ...
  <meta name="twitter:title" content="Codafacil.dev: como usar IA de forma prática | Codafacil.dev" />
  ...
  <script type="application/ld+json">
{
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://codafacil.dev/2026/04/14/codafacil-ia-2026-04-14/"
  },
  "image": [
    "https://codafacil.dev/imagens/posts/codafacil-ia-2026-04-14.jpg"
  ],
  "author": {
    "@type": "Organization",
    "name": "Codafacil.dev"
...
<body class="min-h-screen bg-[#04110d] text-white antialiased">
  ...
  <main class="mx-auto max-w-4xl px-4 py-8 sm:px-6 sm:py-10">
    ...
    <article class="mt-5 rounded-3xl border border-white/15 bg-white/5 p-5 sm:p-8">
      <p class="text-xs font-semibold uppercase tracking-[0.22em] text-white/55">Blog Codafacil.dev • 14/04/2026</p>
      <h1 class="mt-3 text-3xl font-semibold leading-tight text-white sm:text-4xl">Codafacil.dev: como usar IA de forma prática</h1>
      ...
      <img src="../../../../imagens/posts/codafacil-ia-2026-04-14.jpg" alt="Codafacil.dev: como usar IA de forma prática" class="mt-6 w-full rounded-2xl border border-white/15" width="1200" height="630" loading="lazy" />
