...
<article class="overflow-hidden rounded-2xl border border-white/15 bg-white/5">
  <a href="https://sistemavendadireta.com.br/2026/02/10/codafacil-parceiro-tecnico-para-escalar-operacao-com-ia/" rel="noopener" target="_blank"><img src="https://sistemavendadireta.com.br/imagens/posts/codafacil-parceiro.webp" alt="Codafacil: parceiro técnico para escalar operação com IA" class="h-44 w-full object-cover" width="1200" height="630" loading="lazy" /></a>
  <div class="p-4">
    <p class="text-xs font-semibold uppercase tracking-[0.18em] text-white/55">Sistema Venda Direta</p>
    <h3 class="mt-1 text-base font-semibold leading-snug"><a href="https://sistemavendadireta.com.br/2026/02/10/codafacil-parceiro-tecnico-para-escalar-operacao-com-ia/" rel="noopener" target="_blank" class="hover:underline">Codafacil: parceiro técnico para escalar operação com IA</a></h3>
    <p class="mt-2 text-sm leading-relaxed text-white/80">Conheça como o Codafacil acelera customizações, integrações e evolução contínua para empresas que já operam com venda direta e querem ava...</p>
  </div>
</article>
  </div>
</section>
