...
<body class="min-h-screen bg-[#04110d] text-white antialiased">
  ...
  <main class="mx-auto max-w-4xl px-4 py-8 sm:px-6 sm:py-10">
    ...
    <article class="mt-5 rounded-3xl border border-white/15 bg-white/5 p-5 sm:p-8">
      <p class="text-xs font-semibold uppercase tracking-[0.22em] text-white/55">Blog Codafacil.dev • 26/04/2026</p>
      <h1 class="mt-3 text-3xl font-semibold leading-tight text-white sm:text-4xl">Codafacil.dev: como usar TECNOLOGIA de forma prática</h1>
      <p class="mt-5 text-base leading-7 text-white/80 sm:text-lg">Guia objetivo sobre software sob medida com IA aplicada com foco em resultado operacional.</p>

      <img src="../../../../imagens/posts/codafacil-tecnologia-2026-04-26.jpg" alt="Codafacil.dev: como usar TECNOLOGIA de forma prática" class="mt-6 w-full rounded-2xl border border-white/15" width="1200" height="630" loading="lazy" />
